...
def main():
    ...
    tweet_repository = TweetRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
    annotation_repo = AnnotationRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
    hashtag_repo = HashtagRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
    url_repo = UrlRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
    image_repo = ImageRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
    entity_repo = EntityRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
    domain_repo = DomainRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
    context_entity_repo = ContextEntityRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
    context_annotation_repo = ContextAnnotationRepository(host = "localhost", user = "root", password = "", database = "TwitterData")
